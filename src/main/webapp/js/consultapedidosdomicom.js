...
function consultarPedido() 
{
	...
	var idPlataforma = $("#selectPlataforma option:selected").attr('id');
	var integracion = $("#selectIntegracion").val();
	//
	...
	$.getJSON(server + 'ConsultaIntegradaPedidosDomicom?fechainicial=' + fechaini +"&fechafinal=" + fechafin + "&tienda=" + tienda +  "&numeropedido=" + numpedido + "&estado=" + estado+"&estadotienda=" + estadoTienda +"&idplataforma=" + idPlataforma + "&integracion=" + integracion, function(data1){
...
function aceptarPedidoPlataforma()
{
	if(idMarcacionSel == 2)
	{
		$.getJSON(server + 'AceptarPedidoIntegracionRAPPI?idordencomercio=' + idOrdenComercio, function(data2){
	        if(data2.respuesta == 'OK')
	        {
	        	$.alert('Pedido aceptado en la plataforma.');
	        	consultarPedido();
	        }
	    })
		.done(function() {
	    ...
	    ;
	}else if(idMarcacionSel == 1)
	{
		$.getJSON(server + 'AceptarPedidoIntegracionDIDI?idordencomercio=' + idOrdenComercio, function(data2){
	        if(data2.respuesta == 'OK')
	        {
	        	$.alert('Pedido aceptado en la plataforma.');
	        	consultarPedido();
	        ...
	        {
	        	$.alert('ERROR aceptando pedido en la plataforma.');
	        }
	    })
		.done(function() {
		    console.log( "second success" );
