...
$(document).ready(function() {
    ...
    $('#grid-encabezadopedido').on('click', 'tr', function () {
        ...
        //Tomamos la fecha de inserción para hacer validaciones despues
        fechaInsercion = datospedido.fechainsercion;
...
function consultarPedido() 
{
	...
	$.getJSON(server + 'ConsultaIntegradaPedidosNuevaTienda?fechainicial=' + fechaini +"&fechafinal=" + fechafin + "&tienda=" + tienda +  "&numeropedido=" + numpedido + "&estado=" + estado+"&estadotienda=" + estadoTienda + "&origenpedido=APP" , function(data1){
