...
$(document).ready(function() {
    ...
    $('#grid-encabezadopedido').on('click', 'tr', function () {
        ...
        //Vamos a realizar la prueba del llamado a la api de Epayco
        if(datospedido.formapago = 'Tienda Virtual-Epayco')
        {
        	//Aqui realizaremos la prueba del llamado de la API de ePayco
        	var jsonConsulta = '{' +
	            '"public_key":"51f8780e77c3af7b5ad8ba07b0e0951a", ' +
	            '"refPayco":"", '+
	            '"refCliente":"6399", '+
	            '"descripcion":"", '+
	            '"autorizacion":"", '+
	            ...
	            '"email":"", '+
	            '"docPagador":"", '+
	            '"fechaInicioTransaccionInicial":"2020-08-05-00-01-03", '+
	            '"fechaFinTransaccionInicial":"2020-08-05-22-12-03", '+
	        ...
	        $.ajax({
	                ...
	                headers: {'Authorization': "Bearer " + '51f8780e77c3af7b5ad8ba07b0e0951a'},
	                dataType: 'json', 
	                type: 'post',
	                data: jsonConsulta, 
...
function consultarPedido() 
{
	...
	$.getJSON(server + 'ConsultaIntegradaPedidosTienda?fechainicial=' + fechaini +"&fechafinal=" + fechafin + "&tienda=" + tienda +  "&numeropedido=" + numpedido + "&estado=" + estado+"&estadotienda=" + estadoTienda, function(data1){
