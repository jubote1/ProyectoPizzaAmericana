...
function consultarPedido() 
{
	...
	$.getJSON(server + 'ConsultaIntegradaPedidosNuevaTienda?fechainicial=' + fechaini +"&fechafinal=" + fechafin + "&tienda=" + tienda +  "&numeropedido=" + numpedido + "&estado=" + estado+"&estadotienda=" + estadoTienda + "&origenpedido=CRM", function(data1){
