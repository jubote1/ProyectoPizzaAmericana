 ...
 */
@WebServlet("/ConsultaIntegradaPedidosRAPPICARGO")
public class ConsultaIntegradaPedidosRAPPICARGO extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultaIntegradaPedidosRAPPICARGO() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        logger.info("Llamado a servicio con par�metros fechainicial " + fechainicial + " fechafinal " + fechafinal + " tienda "+ tienda);
        PedidoCtrl consultapedido = new PedidoCtrl();
        String respuestaConsulta = consultapedido.ConsultaIntegradaPedidosRAPPICARGO(fechainicial, fechafinal, tienda, idEstadoPedido, enviadoPixel);
