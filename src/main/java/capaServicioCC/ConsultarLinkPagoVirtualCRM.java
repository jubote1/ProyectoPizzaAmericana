 ...
 */
@WebServlet("/ConsultarLinkPagoVirtualCRM")
public class ConsultarLinkPagoVirtualCRM extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarLinkPagoVirtualCRM() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String respuesta = pedidoCtrl.consultarLinkPagoVirtualCRM(data, authHeader); 
