 ...
 */
@WebServlet("/ConsultaIntegradaPedidosTienda")
public class ConsultaIntegradaPedidosTienda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultaIntegradaPedidosTienda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuestaConsulta = consultapedido.ConsultaIntegradaPedidosTienda(fechainicial, fechafinal, tienda, numeropedido, idEstadoPedido, enviadoPixel);
