 ...
 */
@WebServlet("/ValidarExistenciaCodigoRedencion")
public class ValidarExistenciaCodigoRedencion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ValidarExistenciaCodigoRedencion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String respuesta = fidCtrl.validarExistenciaCodigoRedencion(codigo, correo, fechaSistema);
