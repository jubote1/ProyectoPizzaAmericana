 ...
 */
@WebServlet("/ExisteSolicitudConciliacion")
public class ExisteSolicitudConciliacion extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExisteSolicitudConciliacion() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String respuesta = pedCtrl.existeSolicitudConciliacion(idTienda);
