 ...
 * 
 */
@WebServlet("/ConsultarEstadosPedidoTienda")
public class ConsultarEstadosPedidoTienda extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultarEstadosPedidoTienda() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = PedidoCtrl.consultarEstadosPedidoTienda(idTienda);
