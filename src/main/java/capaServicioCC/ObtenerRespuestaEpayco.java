...
public class ObtenerRespuestaEpayco extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			//Esta parte es modificada pues los parámetros no llegará asi
...
//			String dataJSON = sb.toString();
			...
			//Realizamos cambio para tomar los parámetros
			...
			String respuesta = pedidoCtrl.capturarEventoPagoEpayco(idOrdenComercio, codRespuesta, tipoPago);
