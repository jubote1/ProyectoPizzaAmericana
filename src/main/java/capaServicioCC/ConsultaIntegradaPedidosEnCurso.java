 ...
 */
@WebServlet("/ConsultaIntegradaPedidosEnCurso")
public class ConsultaIntegradaPedidosEnCurso extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConsultaIntegradaPedidosEnCurso() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuestaConsulta = consultapedido.ConsultaIntegradaPedidosEnCurso(fechainicial, fechafinal, tienda, numeropedido, idEstadoPedido, enviadoPixel);
