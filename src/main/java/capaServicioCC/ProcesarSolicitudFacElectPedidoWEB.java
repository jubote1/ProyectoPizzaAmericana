 ...
 */
@WebServlet("/ProcesarSolicitudFacElectPedidoWEB")
public class ProcesarSolicitudFacElectPedidoWEB extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ProcesarSolicitudFacElectPedidoWEB() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String respuesta = pedidoCtrl.procesarSolFacturaPedidoWebBOTNiv1(data, authHeader); 
