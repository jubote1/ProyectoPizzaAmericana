 ...
 * 
 */
@WebServlet("/ObtenerResumenDomiciliarioApp")
public class ObtenerResumenDomiciliarioApp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerResumenDomiciliarioApp() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String respuesta = PedidoCtrl.obtenerResumenDomiciliarioApp(idTienda, claveUsuario);
