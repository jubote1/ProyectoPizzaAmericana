 ...
 */
@WebServlet("/InsertarPedidoCRMBOT2")
public class InsertarPedidoCRMBOT2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public InsertarPedidoCRMBOT2() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String respuesta = pedidoCtrl.insertarPedidoCRMBOT(data, authHeader); 
