...
public class SolicitudPQRSCtrl {
	...
	/**
	 * M�todo de la capa controladora que recibe los par�metros de la entidad SolicitudPQRS se encarga de crear el objeto correspondiente
	 * e invoca la capa DAO para la inserci�n de la entidad.
	 ...
	 * @param idmunicipio
	 * @param comentario
	 * @return Retorna un entero con el idSolicitudPQRS que retorna la base de datos en la creaci�n del mismo.
	 */
