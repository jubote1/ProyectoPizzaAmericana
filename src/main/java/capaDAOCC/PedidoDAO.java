...
public class PedidoDAO {
	 ...
	 * @param descuento
	 */
	public static void finalizarPedidoPOSPMTiendaVirtual(int idpedido, int idformapago, int idcliente, double tiempopedido, double descuento, double valorFormaPago, String programado, String horaProgramado, int idEstadoPedido)
	{
		Logger logger = Logger.getLogger("log_file");
		ConexionBaseDatos con = new ConexionBaseDatos();
		Connection con1 = con.obtenerConexionBDPrincipal();
