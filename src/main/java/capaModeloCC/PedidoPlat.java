...
public class PedidoPlat {
	...
	private BigInteger idOrdenComercio;
	...
	public BigInteger getIdOrdenComercio() {
		return idOrdenComercio;
	}
	public void setIdOrdenComercio(BigInteger idOrdenComercio) {
	...
	public PedidoPlat(int idpedido, String nombretienda, double totalbruto, double impuesto, double total_neto,
